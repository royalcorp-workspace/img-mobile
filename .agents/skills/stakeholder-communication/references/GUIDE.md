...
This guide provides comprehensive documentation for the **stakeholder-communication** skill in the custom-plugin-product-manager plugin.
...
```bash
# Invoke the skill
claude "stakeholder-communication - [your task description]"

# Example
claude "stakeholder-communication - analyze the current implementation"
```
...
def implement_stakeholder_communication(input_data):
    """
    Implement stakeholder-communication functionality.
