...
This guide provides comprehensive documentation for the **pricing** skill in the custom-plugin-product-manager plugin.
...
```bash
# Invoke the skill
claude "pricing - [your task description]"

# Example
claude "pricing - analyze the current implementation"
```
...
def implement_pricing(input_data):
    """
    Implement pricing functionality.
