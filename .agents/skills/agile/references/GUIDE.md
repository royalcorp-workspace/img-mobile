...
This guide provides comprehensive documentation for the **agile** skill in the custom-plugin-product-manager plugin.
...
```bash
# Invoke the skill
claude "agile - [your task description]"

# Example
claude "agile - analyze the current implementation"
```
...
def implement_agile(input_data):
    """
    Implement agile functionality.
