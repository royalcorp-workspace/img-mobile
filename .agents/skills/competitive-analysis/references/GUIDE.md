...
This guide provides comprehensive documentation for the **competitive-analysis** skill in the custom-plugin-product-manager plugin.
...
```bash
# Invoke the skill
claude "competitive-analysis - [your task description]"

# Example
claude "competitive-analysis - analyze the current implementation"
```
...
def implement_competitive_analysis(input_data):
    """
    Implement competitive-analysis functionality.
